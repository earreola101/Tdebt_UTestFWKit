...
typedef enum eBTCmd
{
	...
	TDE_CMD_BT_GET_PSKEY_EXT	= 31, // JuiwenHsu@2013-0996
    TDE_CMD_BT_SET_PSKEY_EXT	= 32, // JuiwenHsu@2013-0996
	TDE_CMD_SET_TestStationN_PASS   = 33,// for mariner
	TDE_CMD_GET_TestStationN_PASS	= 34,// for mariner
	TDE_CMD_SET_TestStationN_FAIL	= 35,// for mariner
	TDE_CMD_GET_TestStationN_FAIL 	= 36,// for mariner
	TDE_CMD_Get_TestStationN_Flag   = 37,// for mariner
	TDE_CMD_Set_TestStationN_Flag   = 38,// for mariner
	TDE_CMD_SET_Video_USB_SerialNum	= 39,// for mariner
	TDE_CMD_GET_Video_USB_SerialNum	= 40,// for mariner
	TDE_CMD_SET_Audio_USB_SerialNum	= 41,// for mariner
	TDE_CMD_GET_Audio_USB_SerialNum = 42,// for mariner
	TDE_CMD_SET_Tx_CARRIER_ON_OFF   = 43,// for mariner
	TDE_CMD_GET_HDCP_Key         	= 44,// for mariner
	TDE_CMD_SET_HDCP_Key 	        = 45,// for mariner
	TDE_CMD_GET_BATTERY_STATUS 	    = 46,// for mariner
	TDE_CMD_GET_BATTERY_VOLTAGE	    = 47,// for mariner
	TDE_CMD_GET_BATTERY_TEMP 	    = 48,// for mariner
	TDE_CMD_GET_POWER_MODE 	        = 49,// for mariner
	TDE_CMD_GET_ADAPTER_POWERED 	= 50,// for mariner
	TDE_CMD_GET_USB_POWERED	        = 51, // for mariner
	TDE_CMD_GET_BATTERY_POWERED	    = 52, // for mariner	
    TDE_CMD_SET_LED_COLOR	        = 53, // for mariner	
    TDE_CMD_GET_BUTTON_STATUS       = 54, // for mariner
	TDE_CMD_GET_Tx_CARRIER_ON_OFF   = 55, // for mariner
	TDE_CMD_FAIL				    = 0xFF,
	TDE_CMD_MAX
} TDE_CMD; 
